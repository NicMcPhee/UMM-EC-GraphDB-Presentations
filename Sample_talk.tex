...
\begin{frame}
  ...
  \begin{column}{0.45\textwidth}
   \includegraphics[width=0.95\textwidth]{graphdb-neo4j.png}
       \\
    \only{\tiny{Neo4j \\ \url{http://www.neo4j.org/learn/graphdatabase} }}
  \end{column}
  \end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.45\textwidth}
\includegraphics[width=.7\textwidth]{crossover-root-and-nonroot.png} \\
...
\item[Population Size Per Gen] 1,000 (6 runs) and 10,000 (1 run)
